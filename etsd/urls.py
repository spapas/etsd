...
urlpatterns = [
    ...
    path(
        "authorities/create",
        permission_required("core.admin")(AuthorityCreateView.as_view()),
        name="authority_create",
    ),
    path(
        "authorities/update/<int:pk>/",
        permission_required("core.admin")(AuthorityUpdateView.as_view()),
        name="authority_update",
    ),
    path(
        "authorities/view/<int:pk>/",
        permission_required("core.admin")(AuthorityDetailView.as_view()),
        name="authority_view",
    ),
    path(
        "authorities/update_data/<int:pk>/",
        any_permission_required("core.admin", "core.user")(
            AuthorityEditUsersView.as_view()
        ),
        name="authority_update_data",
    ),
]
