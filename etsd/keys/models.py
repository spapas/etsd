...
class PublicKey(UserDateAbstractModel):
    ...
    status = models.CharField(max_length=10, choices=KEY_STATUS_CHOICES, default='PENDING')
    confirmation_document = models.FileField(upload_to='confirmations/%Y/%m/%d/', null=True, blank=True)
